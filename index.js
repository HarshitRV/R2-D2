 ...
 */
// Help commands.
import { help, musicHelp, filterHelp } from "./commands/core/help.js";
...
// Private commands
import { chatGPTCompletion } from "./commands/openAI/openaiChatGPT.js";
	...
	try {
		...
		switch (`${args[0].toLowerCase()}`) {
			...
			case `help`:
				...
				break;
			case `music`:
				musicHelp(msg, prefix);
				break;
			case `filter-list`:
				filterHelp(msg, prefix);
				break;
			...
			// Exclusive commands
			case `sarcasm`:
				getSarcasticComment(msg);
				break;
			case `phil`:
				randomPhilsosophy(msg, philsosophy);
				break;
			case `fightclub`:
				getFightClubQuote(msg);
				break;
			case `r2d2`:
				openAI(msg, args);
				break;
			...
			// Private chat gpt command
			case `gpt`:
				chatGPTCompletion(msg, args);
				break;
